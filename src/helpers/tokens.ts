...
export function removeUsdDecimals(quantity: BigDecimal): BigDecimal {
  return quantity.times(BigDecimal.fromString('100000000'))
}
...
export function getTokenBalance(
  ...
  if (balanceCall.reverted) {
    log.critical('balanceOf() reverted for {}', [strategyAddress.toHexString()])
  }
